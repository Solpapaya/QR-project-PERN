...
import DeletedTaxReceiptsTable from "./DeletedTaxReceiptsTable";
...
const DeletedTaxReceiptsList = () => {
  ...
  return (
    <div className="table-container">
      {isSearchSuccessful ? <DeletedTaxReceiptsTable /> : "No Matches"}
    </div>
  );
};

export default DeletedTaxReceiptsList;
